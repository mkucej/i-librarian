            ...
            <div class="alternating_row ui-corner-bottom" style="padding:4px 7px;overflow:auto;height:55px">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <span class="fa fa-exclamation-triangle ui-state-error-text" title="Flash does not support basic authentication and self-signed certificates. Flash behavior when working through a proxy server is inconsistent and unreliable."></span>
                        </td>
                    </tr>
                </table>
